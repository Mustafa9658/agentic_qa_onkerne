"""
OnKernal Agent Cloud Events

These events work WITHOUT cloud_sync - all from_agent() methods gracefully handle
missing cloud_sync by setting device_id=None. Events can also be created manually
or via workflow-specific factory methods.

Events are dispatched via bubus.EventBus for telemetry and observability.
"""
import base64
import os
