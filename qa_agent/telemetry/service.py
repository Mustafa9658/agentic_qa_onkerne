...
from qa_agent.telemetry.views import BaseTelemetryEvent
from qa_agent.utils import singleton
...
class ProductTelemetry:
	...
	def __init__(self) -> None:
		...
		if telemetry_disabled:
			...
			logger.info('Using anonymized telemetry, see https://docs.browser.com/development/telemetry.')
