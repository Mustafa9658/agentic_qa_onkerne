...
from qa_agent.agent.views import ActionModel, ActionResult
...
from qa_agent.browser.views import BrowserError
from qa_agent.dom.service import EnhancedDOMTreeNode
from qa_agent.filesystem.file_system import FileSystem
from qa_agent.llm.base import BaseChatModel
from qa_agent.llm.messages import SystemMessage, UserMessage
...
from qa_agent.utils import time_execution_sync
...
class Tools(Generic[Context]):
	def __init__(
		...
		async def extract(
			...
			try:
				from qa_agent.dom.markdown_extractor import extract_clean_markdown
...
""".strip()
		...
		async def select_dropdown(params: SelectDropdownOptionAction, browser_session: BrowserSession):
			...
			from qa_agent.browser.events import SelectDropdownOptionEvent
