...
from qa_agent.browser.events import (
...
from qa_agent.browser.profile import BrowserProfile, ProxySettings
from qa_agent.browser.views import BrowserStateSummary, TabInfo
from qa_agent.dom.views import DOMRect, EnhancedDOMTreeNode, TargetInfo
from qa_agent.observability import observe_debug
from qa_agent.utils import _log_pretty_url, is_new_tab_page

if TYPE_CHECKING:
	from qa_agent.actor.page import Page
...
class BrowserSession(BaseModel):
	...
	async def kill(self) -> None:
		...
		from qa_agent.browser.events import SaveStorageStateEvent
	...
	async def on_NavigateToUrlEvent(self, event: NavigateToUrlEvent) -> None:
		...
		if event.new_tab:
			try:
				...
				from qa_agent.utils import is_new_tab_page
	...
	async def new_page(self, url: str | None = None) -> 'Page':
		...
		from qa_agent.actor.page import Page as Target
	...
	async def attach_all_watchdogs(self) -> None:
		...
		from qa_agent.browser.watchdogs.aboutblank_watchdog import AboutBlankWatchdog

		# from qa_agent.browser.crash_watchdog import CrashWatchdog
		from qa_agent.browser.watchdogs.default_action_watchdog import DefaultActionWatchdog
		...
		from qa_agent.browser.watchdogs.screenshot_watchdog import ScreenshotWatchdog
		from qa_agent.browser.watchdogs.security_watchdog import SecurityWatchdog
		from qa_agent.browser.watchdogs.storage_state_watchdog import StorageStateWatchdog
	...
	async def connect(self, cdp_url: str | None = None) -> Self:
		...
		try:
			...
			from qa_agent.browser.session_manager import SessionManager
	...
	async def navigate_to(self, url: str, new_tab: bool = False) -> None:
		...
		"""
		from qa_agent.browser.events import NavigateToUrlEvent
