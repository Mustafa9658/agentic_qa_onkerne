...
from qa_agent.dom.views import (
	EnhancedDOMTreeNode,
	SerializedDOMState,
)
from qa_agent.observability import observe_debug
from qa_agent.utils import time_execution_async

if TYPE_CHECKING:
	from qa_agent.browser.views import BrowserStateSummary, NetworkRequest, PageInfo, PaginationButton
...
class DOMWatchdog(BaseWatchdog):
	...
	async def _get_pending_network_requests(self) -> list['NetworkRequest']:
		...
		"""
		from qa_agent.browser.views import NetworkRequest
...
"""
	...
	async def on_BrowserStateRequestEvent(self, event: BrowserStateRequestEvent) -> 'BrowserStateSummary':
		...
		"""
		from qa_agent.browser.views import BrowserStateSummary, PageInfo
		...
		try:
			...
			if (
				...
				try:
					...
					from qa_agent.browser.python_highlights import create_highlighted_screenshot_async
	...
	def _detect_pagination_buttons(self, selector_map: dict[int, EnhancedDOMTreeNode]) -> list['PaginationButton']:
		...
		"""
		from qa_agent.browser.views import PaginationButton
	...
	async def _get_page_info(self) -> 'PageInfo':
		...
		from qa_agent.browser.views import PageInfo
