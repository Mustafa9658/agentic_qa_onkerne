...
from qa_agent.dom.views import NodeType, SimplifiedNode
from qa_agent.llm.messages import ContentPartImageParam, ContentPartTextParam, ImageURL, SystemMessage, UserMessage
from qa_agent.observability import observe_debug
from qa_agent.utils import is_new_tab_page

if TYPE_CHECKING:
	from qa_agent.agent.views import AgentStepInfo
	from qa_agent.browser.views import BrowserStateSummary
...
class SystemPrompt:
	...
	def _load_prompt_template(self) -> None:
		...
		try:
			...
			prompt_file = Path(__file__).parent / template_filename
